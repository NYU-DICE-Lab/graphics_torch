...
def print_tensors_in_checkpoint_file(file_name, tensor_name, all_tensors,
  ...
  try:
    ...
    if all_tensors or all_tensor_names:
      ...
      with open("param_names.txt","w") as f:
        f.write(reader.debug_string().decode("utf-8", errors="ignore"))
...
def save_all():
  param_vals = []
  with open("tensorflow_graphics/projects/neural_voxel_renderer/param_names.txt","r") as f:
    lines = f.readlines()
  for line in lines:
    name = line.split(" ")[0]
    tensor = print_tensors_in_checkpoint_file(
        '/tmp/checkpoint/model.ckpt-126650', name,
        False, False,
        count_exclude_pattern='')
    param_vals.append([name,tensor])
  with open ("param_vals.npy","wb") as f:
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--file_name",
      type=str,
      default="/tmp/checkpoint/model.ckpt-126650",
  ...
  parser.add_argument(
      "--tensor_name",
      type=str,
      default="Network/Decoder/batch_normalization_36/beta",
